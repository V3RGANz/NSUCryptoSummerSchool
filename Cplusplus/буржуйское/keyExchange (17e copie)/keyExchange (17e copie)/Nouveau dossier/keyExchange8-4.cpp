...
//                          {-27 , -29 , -1 , -36 , -17 , -65 , 56 , -16 , -24 , 73 , -83 , 14}};
  ...
  vector<vector<int>> S{{77 , -56 ,47 ,98 , -61 ,36 , -77 ,65},
   {-85 ,91 ,16 ,81 , -84 , -45 , -40 ,59},
   { 30 , -96 , -75 , -38 , -62 ,70 , -59 ,42},
   { 11 ,17 ,39 ,84 ,35 , -25 ,31 , -95},
   { 71 ,34 ,74 , -52 , -73 , -92 ,-6 , -49},
   {-39 ,89 , -10 ,21 ,62 ,96 , -81 , -16},
   { 49 , -93 , -89 ,-9 ,76 , -22 , -55 , -72},
   { 54 ,40 ,-2 ,90 ,94 ,25 , -60 ,86}};
...
//                          {0, 2, 7}};
    //grassmanCalcul(S,3);
    display2Dim(grassmanCalcul(S,4));


//  for (int n = 2; n<20; n++){
//      for(int k = 2; k<n-1; k++){
//          if(pow(comb(n,k).size(), 2)<5000 && pow(comb(n,k).size(), 2)>4100 && (pow(comb(n,k).size(), 2) / k >1000) ){
//              cout<<n<<" "<<k<<" "<<comb(n,k).size()<<"   "<<pow(comb(n,k).size(), 2)<<"   "<<pow(comb(n,k).size(), 2) / k<<endl;
//          }
//      }
//  }
